            ...
            <?php for ($i = 1; $i <= 12; $i++) { ?>
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-3">
                    <div class="container bg-modal sombra redondear p-3">
                        ...
                        <div>
                            <select class="form-select btn-primary" name="cboDelivery" aria-label="Default select example">
                                <option value="1">Manuel Laos</option>
                                <option value="2">Erica Blas</option>
                                <option value="3">Roberto Rojas</option>
                            </select>
                        </div>
                        <hr>
